...
[![tools](https://skillicons.dev/icons?i=anaconda,bootstrap,c,cpp,cloudflare,css,docker,fastapi,flask,git,github,githubactions,html,java,jest,js,latex,linux,nextjs,nginx,nodejs,notion,postman,prisma,py,rails,raspberrypi,react,ruby,supabase,sklearn,selenium,sqlite,ts,ubuntu,vercel,vim,vscode,workers&perline=12)](https://skillicons.dev)
