...
[![tools](https://skillicons.dev/icons?i=anaconda,c,cpp,docker,fastapi,flask,git,github,githubactions,java,jest,js,latex,linux,nginx,nodejs,notion,perl,postman,py,rails,raspberrypi,react,ruby,sklearn,selenium,sqlite,ts,ubuntu,vercel,vim,vscode&perline=12)](https://skillicons.dev)
