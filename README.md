...
[![tools](https://skillicons.dev/icons?i=astro,aws,bootstrap,c,cpp,cloudflare,css,docker,fastapi,flask,gcp,git,github,githubactions,grafana,html,idea,java,jest,js,kubernetes,latex,linux,nextjs,nginx,nodejs,notion,postgres,postman,py,rails,raspberrypi,react,redis,remix,supabase,sklearn,spring,sqlite,tailwind,terraform,ts,ubuntu,vercel,vim,vitest,vscode,workers&perline=12)](https://skillicons.dev)
